                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                              <a href="showAllUser.jsp" class="dropdown-item">show all users</a>
                             <a href="showAllProduct.jsp" class="dropdown-item">show all products</a>
                               <a href="showAllAdmin.jsp" class="dropdown-item">show all admin </a>
                             </div>
                     ...
                     <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                              <a href="create_admin.jsp" class="dropdown-item">create admins</a>
                             <a href="create_product.jsp" class="dropdown-item">create products</a>
                                 <a href="profile_admin.jsp" class="dropdown-item">edit admin</a>
                             </div>
